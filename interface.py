import sys
from PySide6.QtWidgets import QMessageBox, QApplication, QMainWindow, QLabel, QLineEdit, QVBoxLayout, QHBoxLayout, QPushButton, QWidget, QSpacerItem, QSizePolicy
...
class SingupWindow(QMainWindow):
    def __init__(self):
        ...
        pixmap = QPixmap("./photo1.jfif")  # Provide the correct path to your background image
        ...
        submit_button.setStyleSheet("background-color: black; color: white ; border-radius:10px; padding: 10px ; height : 20px;")
